  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(hasDropdown ? "hidden" : "", "text-sm font-medium"),
        caption_dropdowns: "flex items-center justify-between space-x-2 text-xs rounded-md flex-1",
        dropdown: "py-1 rounded w-full",
        vhidden: "sr-only",
